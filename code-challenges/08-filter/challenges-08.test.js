...
const oddValues = (arr) => {
    let odds = arr.filter( value => (value % 2));
    return odds;
};
...
const filterStringsWithVowels = (arr) => arr.filter( value => /[aeiou]/gmi.test(value));
...
// ****************************** LINTER ERROR **************************
// const getStatName = (arr, minBaseStat) => arr.filter( obj.stat.name => obj.baseStat > minBaseStat);
